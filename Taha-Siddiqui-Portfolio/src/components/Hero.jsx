...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen h-screen flex items-center relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="hero-topbar absolute top-0 left-0 right-0 bg-primary bg-opacity-50 flex justify-between items-center px-6 py-1 border-b border-muted border-opacity-10">
        <div className="font-mono text-xs text-muted">{formatTime(currentTime)}-{formatDate(currentTime)}</div>
        <div className="font-mono text-xs text-muted">~TAHA SIDDIQUI</div>
      </div>
      ...
      <div className="container-custom"> {/* Main container for hero content */}
        ...
        <motion.div
          className="hero-content max-w-3xl -ml-[20vh]"
        ...
        >
          ...
          >
            ...
            <div className="nothing-headline font-mono tracking-wide">
              <DottedText text="TAHA SIDDIQUI" />
            </div>
            <div className="mt-3 text-gradient">Full Stack Developer &  <br />AI Enthusiast</div>
          </motion.h1>

          <motion.p
            variants={childVariants}
            className="text-muted text-lg md:text-xl mb-10 max-w-xxl"
          >
            ...
            Passionate about crafting intuitive user experiences and exploring Generative AI. <br />
            Currently expanding expertise in LLMs and RAG-powered intelligent systems.
          </motion.p>
          ...
          >
            <a href="https://github.com/TahaSiddiqui120505" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://leetcode.com/u/TahaSiddiqui12/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
            ...
            <a href="https://www.linkedin.com/in/taha-siddiqui-4086122a5/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-muted hover:text-light transition-colors">
              <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            ...
            <a href="/ATS_Resume.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME
